...
function App() {
  ...
  return (
    <>
      <div className="MAIN w-[480px] font-serif">
        <div className='w-[480px] h-[1181px] bg-[#EEF5F8] font-serif'>
        ...
        <div className='aboutUs'>
          <p className="text-center text-ferozi text-xs">ABOUT US</p>
          <h3 className="text-2xl text-center mt-[50px] mb-[10px]">Crafting Beauty Beyond Boundaries</h3>
          ...
          <img className='mt-[200px] mb-[200px]' src="../public/aboutus/image copy.png" alt="#" />
        ...
        <div className='featuredMain mt-[20px]'>
          ...
          <div className='featured-card'>
            ...
            <p className="opacity-50 text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime accusamus delectus animi optio veniam commodi, et numquam nisi odio dolorum amet officia voluptates aperiam veritatis </p>
            <div className='flex justify-center items-center gap-30 p-[5px]'>
          ...
          <div className='featured-card'>
            ...
            <p className="opacity-50 text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime accusamus delectus animi optio veniam commodi </p>
            <div className='flex justify-center items-center gap-30 p-[5px]'>
              <a href="#">nevila bright</a>
              <a href="#">30 jan 2024</a>
              <button>Tips</button>
          ...
          <div className='featured-card'>
            ...
            <p className="opacity-50 text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime accusamus delectus animi optio veniam commodi, et numquam nisi odio dolorum </p>
            <div className='flex justify-center items-center gap-30 p-[5px]'>
              <a href="#">nevila bright</a>
              <a href="#">30 jan 2024</a>
              <button>Tips</button>
